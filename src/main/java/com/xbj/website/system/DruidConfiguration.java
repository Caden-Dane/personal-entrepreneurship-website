package com.xbj.website.system;
...
public class DruidConfiguration {
    ...
    public ServletRegistrationBean<StatViewServlet> druidServlet() {
        ...
        // IP白名单
        servletRegistrationBean.addInitParameter("allow", "192.168.2.25,10.8.2.152");
        // IP黑名单(共同存在时，deny优先于allow)
        servletRegistrationBean.addInitParameter("deny", "127.0.0.1,10.8.2.25");
        //控制台管理用户
